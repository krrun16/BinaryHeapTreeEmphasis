...
The user may not notice a difference between nodes with this implementation, but depending on the verbosity of their screen reader, they might hear that changed nodes are stressed.
